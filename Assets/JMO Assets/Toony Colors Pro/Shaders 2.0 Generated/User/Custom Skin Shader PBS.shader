...
Shader "Toony Colors Pro 2/User/Custom Skin Shader PBS"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom fullforwardshadows addshadow noambient vertex:vert exclude_path:deferred exclude_path:prepass
		#pragma target 3.0
