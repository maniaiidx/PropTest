...
[ExecuteInEditMode]
public class TwistBoneBehaviour_CustomV2 : MonoBehaviour
{
	...
	public Vector3 _twistAxis;
    public Quaternion _defaultLocalRotation;
    public bool _defaultLocalRotationIsIdentity;
