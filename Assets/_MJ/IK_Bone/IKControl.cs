...
public class IKControl : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        IKLookAtTarget = GameObject.Find("IKLookAtEyeTarget").transform;
        IKRHandTarget = GameObject.Find("IKRHandTarget").transform;
        IKLHandTarget = GameObject.Find("IKLHandTarget").transform;
