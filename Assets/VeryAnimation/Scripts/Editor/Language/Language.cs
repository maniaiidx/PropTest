    ...
    public class Language
    {
        ...
        private static readonly GUIContent[][] LanguageHelps = new GUIContent[(int)LanguageType.Total][]
        {
            ...
            new GUIContent[]
            {
                ...
                new GUIContent("<color=blue>[Very Animation]</color>The Animation Window was closed because the process of putting the Animation Window in the recording state failed for some reason.\nIf this problem recurs, try restarting Unity."),
	            #endregion
            },
            #endregion
            #region Japanese
            new GUIContent[]
            {
                ...
                new GUIContent("<color=blue>[Very Animation]</color>AnimationWindowを録画状態にする処理が何らかの理由で失敗したためAnimationWindowを閉じました。\nこの問題が再現する場合にはUnityを再起動してみてください。"),
	            #endregion
            },
            #endregion
        };
